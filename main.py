...
training_data = pd.read_csv('train.csv') #to read and store in panda dataframe
testing_data = pd.read_csv('test.csv') #to read and store in panda dataframe

print(training_data.shape, testing_data.shape) #to print number of rows and columns

print(training_data.head(10)) #to print top 10 training data

print(training_data.info()) #complete info of the training data
print(training_data['label'].value_counts()) #count number of  positive and negative  tweet
...
testing_data.head(10)  #to print top 10 testing data
